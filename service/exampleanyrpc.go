...
func prepareExampleAnyRpcResponse(ctx context.Context, downstreamResponse any, internalType any, databaseType any, postDbDownstreamResponse any) (*temp.Example, error) {
	return nil, nil
}
